    ...
    <SafeAreaView style={styles.container} edges={[]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.chainSelector}>
          {CHAINS.map(c => (
            <TouchableOpacity key={c} style={[styles.chainChip, settlementChain === c && styles.chainChipActive]} onPress={() => setSettlementChain(c)} activeOpacity={0.7}>
              <ChainBadge chain={c} />
            </TouchableOpacity>
          ))}
        </View>
...
const styles = StyleSheet.create({
  ...
  credRow:   { gap: 4 },
  credLabel: { ...typography.xs, color: colors.textTertiary, fontWeight: '700' as const },
