...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, SafeAreaView, Linking, Clipboard, Alert } from 'react-native';
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ padding:spacing.xl, alignItems:'center' }}>
          <Text style={{ color:colors.textTertiary }}>Transaction not found</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {tx.txHash && (
          <TouchableOpacity style={styles.copyBtn} onPress={() => { Clipboard.setString(tx.txHash); Alert.alert('Copied','Transaction hash copied'); }}>
...
const styles = StyleSheet.create({
  ...
  explorerBtn: { flexDirection:'row', alignItems:'center', justifyContent:'center', gap:8,
                 marginTop:spacing.lg, padding:spacing.md, backgroundColor:colors.tealBg,
                 borderRadius:radius.lg, borderWidth:1, borderColor:colors.tealBorder },
  explorerText: { ...typography.sm, color:colors.teal, fontWeight:'700' },
