  ...
  return (
    <View style={styles.featureRow}>
      <View style={[styles.featureIcon, { backgroundColor: color+'15', borderColor: color+'30' }]}>
        <Text style={{ color, fontWeight:'700', fontSize:16 }}>{icon}</Text>
      </View>
      <View style={{ flex:1 }}>
...
const styles = StyleSheet.create({
  ...
  content:      { flex:1, paddingHorizontal:spacing.xl, justifyContent:'space-between', paddingVertical:spacing.xxxl },
  brandSection: { alignItems:'center', marginTop:spacing.xxxl },
  logoWrap:     { width:88, height:88, borderRadius:radius.xxl, backgroundColor:colors.tealBg2,
                  borderWidth:1.5, borderColor:colors.tealBorder, alignItems:'center', justifyContent:'center', marginBottom:spacing.xl },
  logoText:     { fontSize:36, fontWeight:'700', color:colors.teal },
  ...
  featureRow:   { flexDirection:'row', alignItems:'center', gap:spacing.md, backgroundColor:colors.surface,
