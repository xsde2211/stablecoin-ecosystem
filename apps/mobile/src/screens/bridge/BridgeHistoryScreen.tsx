    ...
    <SafeAreaView style={styles.container}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          contentContainerStyle={{ paddingHorizontal: spacing.xl, paddingBottom: spacing.xxxl, gap: spacing.sm }}
          ...
          renderItem={({ item }) => {
            ...
            return (
              <TouchableOpacity style={styles.card} onPress={() => setExpanded(isExpanded ? null : item.id)}>
...
const styles = StyleSheet.create({
  ...
  detailValue: { ...typography.xs, color:colors.text, fontWeight:'600', ...typography.mono, fontSize:11 },
