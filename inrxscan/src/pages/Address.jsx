...
export default function Address() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 lg:px-8 py-10">
      ...
      {error ? (
        <div className="mt-6"><ErrorState message={error.message} /></div>
      ) : (
        <>
          ...
          <div className="my-6">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="border border-gold/30 bg-gold/5 rounded-lg px-5 py-4 min-w-[180px]">
              ...
              {!data && (
                <div className="border border-ink-line bg-ink-raised/60 rounded-lg px-5 py-4 min-w-[180px] animate-pulse h-[70px]" />
              )}
            </div>
          </div>

          <div className="border border-ink-line bg-ink-raised/60 rounded-lg px-5 py-4 inline-block mb-6">
